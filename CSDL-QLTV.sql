...
--Bảng Mượn sách
INSERT INTO MUONSACH (Maphieumuon,Masach, Masv, Ngaymuon, Ngaytra)
VALUES	('1','MS001', 'SV002', '2022/12/06', '2022/12/12'),
		('2','MS003', 'SV002', '2022/12/11', '2022/12/12'),
		('3','MS001', 'SV001', '2022/12/11', '2023/03/02'),
		('4','MS001', 'SV005', '2022/12/10', '2022/12/11'),
		('5','MS003', 'SV007', '2023/01/01', '2023/03/02'),
		('6','MS004', 'SV007', '2023/10/11', '2023/03/01'),
		('7','MS007', 'SV004', '2023/09/11', '2023/10/30'),
		('8','MS001', 'SV003', '2023/01/02', '2023/01/02'),
		('9','MS005', 'SV006', '2022/12/09 ', '2022/12/12')
