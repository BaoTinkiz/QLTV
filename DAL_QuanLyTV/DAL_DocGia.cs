...
namespace DAL_QuanLyTV
{
    public class DAL_DocGia
    {
        ...
        {
            string sql = "INSERT INTO SINHVIEN VALUES (@madg, @hoten, @ngaysinh, @gt, @diachi)";
        ...
        {
            string sql =string.Format("UPDATE SINHVIEN SET HOTEN = @hoten, NGAYSINH = @ngaysinh, GIOITINH = @gt, DIACHI = @diachi WHERE MASV ='{0}'",docgia.MaDG);
        ...
        {
            string sql = "DELETE FROM SINHVIEN WHERE MASV = @madg";
            string[] name = { "@madg"};
