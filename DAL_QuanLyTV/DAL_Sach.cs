...
namespace DAL_QuanLyTV
{
    public class DAL_Sach
    {
       ...
       public DataTable loadDataSach()
        ...
        {
            string sql = string.Format("INSERT INTO SACH VALUES (@masach, @tensach, @namxb, @nxb,  @tentacgia)");
            string[] name = { "@masach", "tensach", "@namxb", "@nxb", "tentacgia" };
            object[] value = { sach.MaSach, sach.TenSach, sach.NamXuatBan, sach.NhaXuatBan, sach.TenTacGia };
