...
namespace QuanLyThuVien
{
    public partial class frmSach : Form
    {
        ...
        private void dgvSach_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtTenTG.Text = dgvSach.Rows[i].Cells[4].Value.ToString();
            txtNamXB.Text = dgvSach.Rows[i].Cells[2].Value.ToString();
            txtNXB.Text = dgvSach.Rows[i].Cells[3].Value.ToString();
