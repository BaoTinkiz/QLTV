...
namespace QuanLyThuVien
{
    public partial class frmMuonSach : Form
    {
        ...
        private void frmMuonSach_Load(object sender, EventArgs e)
        {
            ...
            cboMaDG.ValueMember = "MASV";
            cboMaDG.DisplayMember = "MASV";
            ...
            dgvMuonSach.Columns["MASV"].HeaderText = "Mã độc giả";
        ...
        private void dgvMuonSach_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            cboMaDG.Text = dgvMuonSach.Rows[i].Cells[1].Value.ToString();
            cboMaDG.SelectedValue = dgvMuonSach.Rows[i].Cells[1].Value.ToString();
            cboMaSach.Text = dgvMuonSach.Rows[i].Cells[2].Value.ToString();
